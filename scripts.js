...
function codificar() {
    ...
    miTexto = texto.replace(/a/ig, '1').replace(/o/ig, '2').replace(/r/ig, '3').replace(/b/ig, 'a').replace(/c/ig, 'o').replace(/d/ig, 'r').replace(/q/ig, 'b').replace(/u/ig, 'c').replace(/e/ig, 'd').replace(/n/ig, 'q4').replace(/l/ig, 'u5').replace(/s/ig, 'e6').replace(/t/ig, 'n').replace(/m/ig, 'l');
...
function decodificar() {
    ...
    miTexto = texto.replace(/l/ig, 'm').replace(/n/ig, 't').replace(/e6/ig, 's').replace(/u5/ig, 'l').replace(/q4/ig, 'n').replace(/d/ig, 'e').replace(/c/ig, 'u').replace(/b/ig, 'q').replace(/r/ig, 'd').replace(/o/ig, 'c').replace(/a/ig, 'b').replace(/3/ig, 'r').replace(/2/ig, 'o').replace(/1/ig, 'a');
